...
class UnavailableAuthRepository : AuthRepository {
    ...
    override suspend fun signUpWithEmail(email: String, password: String, displayName: String) = unavailable()
...
class UnavailableMedicineRepository : MedicineRepository {
    ...
    override suspend fun save(uid: String, draft: MedicineDraft): String = unavailable()
    override suspend fun archive(uid: String, medicineId: String, archived: Boolean) = unavailable()
    override suspend fun delete(uid: String, medicineId: String) = unavailable()
}
...
class UnavailableCountdownRepository : CountdownRepository {
    ...
    override suspend fun cancel(uid: String, state: CountdownState, source: CheckSource): Boolean = unavailable()
...
class UnavailableSettingsRepository : SettingsRepository {
    ...
    override suspend fun update(uid: String, transform: (UserSettings) -> UserSettings) {
